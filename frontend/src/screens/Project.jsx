...
const Project = () => {
    ...
    const send = () => {
        ...
        sendMessage('project-message', {
            message,
            sender: localUserData
        });
        setMessages(prevMessages => [...prevMessages, { sender: localUserData, message }]);
        setMessage('');
    };
            ...
            <section className="left relative flex flex-col h-screen min-w-96 bg-slate-300">
                <header className='flex justify-between items-center p-2 px-4 w-full bg-slate-100 absolute z-10 top-0'>
                    <div className="flex-grow flex justify-center items-center">
                        <button onClick={() => navigate(-1)} className='p-3 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition duration-200 mr-2'>
                            <i className="ri-arrow-left-line text-2xl"></i> {/* Back Button */}
                        </button>
                        <button onClick={() => navigate(1)} className='p-3 bg-green-600 text-white rounded-full shadow-lg hover:bg-green-700 transition duration-200'>
                            <i className="ri-arrow-right-line text-2xl"></i> {/* Forward Button */}
                        </button>
                    </div>
